...
`RankingScorer` 最后一步:**站外**(你没关注的人会看到的)候选,最终分要乘一个 OON 系数降权;**站内**(你的粉丝)不乘(`ranking_scorer.rs:220-239, 272-275`)。

三个推论:

1. **关注你的人是基本盘。** 你的内容对他们默认"全价"分发,不打折 —— 先把关注你的人服务好,这是回报最确定的地方。
2. **破圈要更强。** 你的帖子触达陌生人时,带着一个小于 1 的乘数在竞争。想破圈,内容得明显比对方关注流里的东西更强,才能追平这个折扣。
